<template>
  <div>
    <h1>Counters</h1>
    <p>
      Counters are an advanced feature in SnakeEyes that allows you keep track of per-user, per-channel, or global numbers and trigger specific actions based on this number.
